...
public class Main {
    ...
    if (cliente != null) {
    	System.out.print("Digite a data da Vistoria (YYY-MM-DD): ");
    	String dataVistoria = scanner.nextLine();
    	System.out.print("Digite a hora da vistoeria (HH:MM): ");
    	...
    	if(agendamento != null) {
    		System.out.print("Digite a descricao do item do checklist: ");
